...
class CodeIndexTest {
    ...
    void testIndexCurrentProject() {
        ...
        CodeIndex indexer = new CodeIndex(testEmbeddingClient());
        // 索引测试资源目录
    ...
    void reportsProgressThroughListener() {
        ...
        CodeIndex indexer = new CodeIndex(testEmbeddingClient(), messages::add);
    ...
    private static EmbeddingClient testEmbeddingClient() {
        return new EmbeddingClient("test", "test", "http://localhost", "") {
            @Override
